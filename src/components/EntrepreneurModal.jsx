...
export default function EntrepreneurCard({
  ...
  // WORK GALLERY
  //
  // Kept for compatibility with existing API data.
  // The gallery is no longer displayed on the card.
  // It remains available when EntrepreneurModal opens.
  // =========================================================
  ...
  const handleLike = async (
    ...
    /*
     * Prevent the heart button from
     * opening the entrepreneur profile.
     */
