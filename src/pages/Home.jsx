...
export default function Home() {
  ...
  /*
   * Fetch entrepreneurs from Django backend
   */
  useEffect(() => {
    const fetchEntrepreneurs = async () => {
      try {
        ...
        // Support both normal DRF response and paginated response
      ...
      <section className="py-16 px-6 md:px-8 max-w-7xl mx-auto">
        ...
        {loading && (
          <div className="text-center py-16">
            ...
            <div className="animate-spin rounded-full h-14 w-14 border-b-4 border-amber-500 mx-auto" />
          ...
          <div className="text-center py-16">
            ...
            <div className="max-w-lg mx-auto bg-white rounded-xl shadow-md p-8">
              ...
              <p className="text-slate-500">
                We couldn't connect to the entrepreneurs database.
            ...
            <div className="text-center py-16">
              ...
              <div className="max-w-lg mx-auto bg-white rounded-xl shadow-md p-8">
                ...
                <p className="text-slate-500 mt-3">
                  New entrepreneur profiles will appear here once they
